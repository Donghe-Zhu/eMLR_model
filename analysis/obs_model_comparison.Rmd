...
GLODAP_model <- GLODAP_model %>%
  mutate(
    DIC_model  <- DIC_model * (1000 / rho),
    ALK_model  <- ALK_model * (1000 / rho),
    O2_model   <- O2_model * (1000 / rho),
    NO3_model  <- NO3_model * (1000 / rho),
    PO4_model  <- PO4_model * (1000 / rho),
    SiO3_model <- SiO3_model * (1000 / rho)
  )
